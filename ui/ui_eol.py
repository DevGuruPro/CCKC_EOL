...
################################################################################
## Form generated from reading UI file 'eol.ui'
##
...
class Ui_EOL(object):
    def setupUi(self, EOL):
        if not EOL.objectName():
            EOL.setObjectName(u"EOL")
        EOL.setEnabled(True)
        EOL.resize(815, 360)
        self.centralwidget = QWidget(EOL)
...
"")
        ...
        brush1 = QBrush(QColor(17, 17, 17, 255))
...
"}")
        ...
        self.horizontalLayout.setContentsMargins(60, -1, -1, -1)
        self.logo = QLabel(self.header)
        self.logo.setObjectName(u"logo")
        self.logo.setMinimumSize(QSize(214, 76))
        self.logo.setMaximumSize(QSize(214, 76))
        self.logo.setPixmap(QPixmap(u":/img/img/logo.png"))
        ...
        self.rightButtons = QFrame(self.header)
        self.rightButtons.setObjectName(u"rightButtons")
        self.rightButtons.setMinimumSize(QSize(28, 28))
        ...
        icon = QIcon()
        icon.addFile(u":/img/img/x.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.closeAppBtn.setIcon(icon)
        self.closeAppBtn.setIconSize(QSize(30, 30))
        ...
        self.main.setMinimumSize(QSize(0, 64))
        ...
        self.main.setPalette(palette1)
        self.main.setStyleSheet(u"background-color: rgb(147, 147, 147);\n"
"")
        ...
        self.txtLabel = QLabel(self.main)
        self.txtLabel.setObjectName(u"txtLabel")
        self.txtLabel.setMaximumSize(QSize(16777215, 200))
        font = QFont()
        ...
        EOL.setCentralWidget(self.centralwidget)

        self.retranslateUi(EOL)

        QMetaObject.connectSlotsByName(EOL)
    # setupUi
